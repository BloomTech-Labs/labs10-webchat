          ...
          <div className={[classes.rightContainer, "right-container"].join(' ')}>
            <form noValidate autoComplete='off'>
              ...
              <TextField
                ...
                value={"<Button class='webChatAppBtn'><img class='webChatAppBtnImg'/></Button> <iframe class='wcaIFRAME'></iframe><script src='https://labs10-webchat.netlify.com/snippet.js?company_id="+this.state.company_id+"'></script>"}
                margin='normal'
                variant='outlined'
              />
            </form>
